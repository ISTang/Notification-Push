...
extern QueryPublicAccountsFailedCallbackFunc g_lpQueryPublicAccountsFailedCallbackFunc;
extern PublicAccountsReceivedCallbackFunc g_lpPublicAccountsReceivedCallbackFunc;
extern FollowPublicAccountRepliedCallbackFunc g_lpFollowPublicAccountRepliedCallbackFunc;
extern UnfollowPublicAccountRepliedCallbackFunc g_lpUnfollowPublicAccountRepliedCallbackFunc;
extern GetFollowedPublicAccountsFailedCallbackFunc g_lpGetFollowedPublicAccountsFailedCallbackFunc;
extern FollowedPublicAccountsReceivedCallbackFunc g_lpFollowedPublicAccountsReceivedCallbackFunc;

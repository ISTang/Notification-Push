...
QueryPublicAccountsFailedCallbackFunc g_lpQueryPublicAccountsFailedCallbackFunc;
PublicAccountsReceivedCallbackFunc g_lpPublicAccountsReceivedCallbackFunc;
FollowPublicAccountRepliedCallbackFunc g_lpFollowPublicAccountRepliedCallbackFunc;
UnfollowPublicAccountRepliedCallbackFunc g_lpUnfollowPublicAccountRepliedCallbackFunc;
GetFollowedPublicAccountsFailedCallbackFunc g_lpGetFollowedPublicAccountsFailedCallbackFunc;
FollowedPublicAccountsReceivedCallbackFunc g_lpFollowedPublicAccountsReceivedCallbackFunc;
...
void CALLBACK SetQueryPublicAccountsFailedCallbackFunc(MsgRepliedCallbackFunc lpMsgRepliedCallbackFunc)
{
	g_lpMsgRepliedCallbackFunc = lpMsgRepliedCallbackFunc;
}
void CALLBACK SetPublicAccountsReceivedCallbackFunc(PublicAccountsReceivedCallbackFunc lpPublicAccountsReceivedCallbackFunc)
{
	g_lpPublicAccountsReceivedCallbackFunc = lpPublicAccountsReceivedCallbackFunc;
}
void CALLBACK SetFollowPublicAccountRepliedCallbackFunc(FollowPublicAccountRepliedCallbackFunc lpFollowPublicAccountRepliedCallbackFunc)
{
	g_lpFollowPublicAccountRepliedCallbackFunc = lpFollowPublicAccountRepliedCallbackFunc;
}
void CALLBACK SetUnfollowPublicAccountRepliedCallbackFunc(UnfollowPublicAccountRepliedCallbackFunc lpUnfollowPublicAccountRepliedCallbackFunc)
{
	g_lpUnfollowPublicAccountRepliedCallbackFunc = lpUnfollowPublicAccountRepliedCallbackFunc;
}
void CALLBACK SetGetFollowedPublicAccountsFailedCallbackFunc(GetFollowedPublicAccountsFailedCallbackFunc lpGetFollowedPublicAccountsFailedCallbackFunc)
{
	g_lpGetFollowedPublicAccountsFailedCallbackFunc = lpGetFollowedPublicAccountsFailedCallbackFunc;
}
void CALLBACK SetFollowedPublicAccountsReceivedCallbackFunc(FollowedPublicAccountsReceivedCallbackFunc lpFollowedPublicAccountsReceivedCallbackFunc)
{
	g_lpFollowedPublicAccountsReceivedCallbackFunc = lpFollowedPublicAccountsReceivedCallbackFunc;
}
